...
def to_local(pose=None, o1=None):
    dis_x = o1[0]
    dis_y = o1[1]
...
if __name__ == '__main__':
    ...
    for p in part:
        ...
        data_out_path = '{}/gen/{}/local_{}_data_joint.npy'.format(arg.out_folder, nowTime, p)
        label_out_path = '{}/gen/{}/local_{}_label.pkl'.format(arg.out_folder, nowTime, p)
